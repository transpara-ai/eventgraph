...
import (
	...
	"github.com/lovyou-ai/eventgraph/go/pkg/primitive/layer3"
...
func TestAllPrimitivesRegister(t *testing.T) {
	...
	prims := []primitive.Primitive{
		layer3.NewGroupPrimitive(), layer3.NewRolePrimitive(),
		layer3.NewReputationPrimitive(), layer3.NewExclusionPrimitive(),
		layer3.NewVotePrimitive(), layer3.NewConsensusPrimitive(),
		layer3.NewDissentPrimitive(), layer3.NewMajorityPrimitive(),
		layer3.NewConventionPrimitive(), layer3.NewNormPrimitive(),
		layer3.NewSanctionPrimitive(), layer3.NewForgivenessPrimitive(),
	}
	for _, p := range prims {

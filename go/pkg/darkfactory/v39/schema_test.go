...
func completeTier0Records() []Record {
	...
	return []Record{
		...
		&CapabilityArtifact{CommonNode: common("cap_art_tool_001", TypeCapabilityArtifact, "recorded"), ArtifactID: "capability_artifact_tool_description_001", ArtifactType: "tool_description", Name: "planner tool description", ArtifactVersion: "1.1.0", SourceRepoOrOrigin: "eventgraph", ContentHash: "sha256:tool-description", Owner: "eventgraph", RiskClass: "medium", ActivationScope: "project", EvalRefs: []string{"bench_001"}, HumanReviewRef: "human_review_001", RollbackRef: "cap_version_baseline", UsageLoggingRequired: true},
		&EvolutionOrder{CommonNode: common("evo_001", TypeEvolutionOrder, "accepted"), EvolutionOrderVersion: 1, TargetCapabilityType: "tool_description", TargetRepo: "eventgraph", TargetPath: "go/pkg/darkfactory/v39", RiskClass: "medium", Motivation: "improve deterministic tool routing", EvalSource: "golden tool-routing benchmark", Constraints: []string{"text_only", "no_global_activation"}, ReviewRequirements: []string{"human_review"}},
		&EvalDataset{CommonNode: common("eval_001", TypeEvalDataset, "active"), SourceType: "golden", TrustLevel: "reviewed", TrainCount: 20, ValidationCount: 10, HoldoutCount: 30},
